"""
hashrentalcoind JSONRPC interface
"""
import sys
import os
...
class hashrentalcoinDaemon():
    def __init__(self, **kwargs):
        ...
        # memoize calls to some hashrentalcoind methods
    ...
    @classmethod
    def from_hashrentalcoin_conf(self, hashrentalcoin_dot_conf):
        from hashrentalcoin_config import hashrentalcoinConfig
        config_text = hashrentalcoinConfig.slurp_config_file(hashrentalcoin_dot_conf)
        creds = hashrentalcoinConfig.get_rpc_creds(config_text, config.network)
    ...
    def get_my_gobject_votes(self, object_hash):
        ...
        if not self.gobject_votes.get(object_hash):
            ...
            self.gobject_votes[object_hash] = hashrentalcoinlib.parse_raw_votes(raw_votes)
    ...
    def we_are_the_winner(self):
        ...
        winner = hashrentalcoinlib.elect_mn(block_hash=current_block_hash, mnlist=mn_list)
        my_vin = self.get_current_masternode_vin()
    ...
    def estimate_block_time(self, height):
        ...
        DO NOT CALL DIRECTLY if you don't hashrentalcoin a "Oh Noes." exception.
        """
        current_block_height = self.rpc_command('getblockcount')
        ...
        future_seconds = hashrentalcoinlib.blocks_to_seconds(diff)
    ...
    def has_sentinel_ping(self):
        ...
        return (getinfo['protocolversion'] >= config.min_hashrentalcoind_proto_version_with_sentinel_ping)
